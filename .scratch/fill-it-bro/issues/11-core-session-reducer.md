...
## Acceptance criteria
- [ ] Table-driven test covering every legal edge above.
- [ ] Three illegal transitions throw `IllegalTransition` with state and event in the message.
- [ ] `reduce` never mutates its input (test with frozen objects).
